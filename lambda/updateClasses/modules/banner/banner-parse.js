...
class BannerParse {
    ...
    //makes sure the campus and professor maps have been successfully read and parsed
    async initialize(){
        [this.campus, this.profs] = [JSON.parse(await Promise.resolve(this.campus)),
                                    JSON.parse(await Promise.resolve(this.profs))]
