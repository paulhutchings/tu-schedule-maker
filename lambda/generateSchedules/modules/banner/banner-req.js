...
class BannerRequest {
    ...
    async classSearchPageReq(term){
        ...
        try {
            ...
            console.log('Error with ClassSearchPage request');
            return error;
        }
    }
    ...
    async singleClassSearchReq(term, course){
        ...
        try {
            ...
            console.log('Error with SingleClassSearch request');
            return error;
        }
    }
    ...
    async catalogSearchPageReq(term){
        ...
        try {
            ...
            console.log('Error with CatalogSearchPage request');
            return error;
        }
    }
    ...
    async catalogSearchReq(term, subjects, options={}){
        ...
        try {
            ...
            console.log('Error with CatalogSearch request');
            return error;
        }
    ...
    async detailDescReq(term, course){
        ...
        try {
            ...
            console.log('Error with DetailedCourseDescrption request');
            return error;
        }
    }
}
